...
def lake_pond_expansion(self, element):
    ...
    if self.ATTM_Lakes[element] > 0.0 and self.ATTM_Lakes[element] < 1.0 :
        ...
        # -----------------------------------------------------------------------------------
            ...
            print 'Lake area is beginning at element: ', self.ATTM_Lakes[element], element
            # -------------------------------------
            ...
            # ------------------------------
            self.ATTM_Lakes[element] = self.ATTM_Lakes[element] + \
                                       lake_fraction_increase  - not_enough_land

            print 'Lake area is end: ', self.ATTM_Lakes[element]
